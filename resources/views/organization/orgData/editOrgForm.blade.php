            ...
            <div class="px-3 px-md-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('org.update', ['organization' => $org->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="color" class="form-control form-control-color" id="orgTheme" name="orgTheme" value="{{ $org->theme_color }}" title="Choose your color" required>
                            </div>
