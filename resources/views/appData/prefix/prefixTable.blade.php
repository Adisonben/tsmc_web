                                ...
                                @foreach ($prefixes as $index => $prefix)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-danger btn-sm delete-data-btn" del-id="{{ $prefix->id }}" del-target="prefixes" data-bs-toggle="tooltip" data-bs-title="ลบ"><i class="bi bi-trash"></i></button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
