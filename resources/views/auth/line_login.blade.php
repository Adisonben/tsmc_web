...
<style>
    .card-body {
        ...
        @keyframes dots {
            ...
            40% { color: #00B900; text-shadow: .25em 0 0 transparent, .5em 0 0 transparent; }
            60% { text-shadow: .25em 0 0 #00B900, .5em 0 0 transparent; }
            80%, 100% { text-shadow: .25em 0 0 #00B900, .5em 0 0 #00B900; }
        }
</style>
@endsection
