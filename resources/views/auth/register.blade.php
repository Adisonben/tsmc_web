                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="fname" type="text"
                                        ...
                                        value="{{ old('fname') }}" required autocomplete="first name" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="lname" type="text"
                                        ...
                                        value="{{ old('lname') }}" required autocomplete="last name" autofocus>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="terms">
                                            ฉันยอมรับ <a href="{{ route('terms') }}" target="_blank"
