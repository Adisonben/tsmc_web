    ...
    <form wire:submit.prevent="updateUser">
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" maxlength="15" id="citizen_id" wire:model="citizen_id"
                    placeholder="กรุณากรอกหมายเลขประชาชน">
            </div>
            <div class="col-md-6">
            ...
            @if (!$user->is_tsm)
                ...
                <div class="col-md-4">
                    ...
                    <select id="userBrn" class="form-select" wire:model="branch_id" wire:change="selectedBranchId"
                        required {{ $brns ? '' : 'disabled' }}>
