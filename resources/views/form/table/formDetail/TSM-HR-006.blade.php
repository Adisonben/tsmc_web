        ...
        <div class="row justify-content-center">
            ...
            <div class="px-3 px-md-5 d-flex justify-content-center">
                <div id="exportPaper">
                    ...
                    <p class="text-center fs-5 mb-3 fw-bold">{{ $formPlan?->getForm?->title }}</p>
                    @php
                    ...
                    {{-- <div class="d-flex gap-4 flex-wrap align-items-center mb-4">
                        <div class="">
                            <p class="mb-0">วันที่ : <span class="fw-bold"><u>{{ $createdDate->thaidate('j M Y') }}
                                    </u></span></p>
                        </div>
                    </div> --}}
                                        ...
                                        @foreach ($form_columns ?? [] as $form_column)
                                            @if (($list->hasColumn($form_column->id)) && ($list->hasColumn($form_column->id)->pivot->status))
                                                ...
                                                @if ($listColumnRecord ?? false)
                                                    ...
                                                    @endphp
                                                    <td>
                                                        <p class="text-success text-center">{{ $createdDate->thaidate('j/m/Y') }}</p>
                                                    </td>
                                                @else
                                                    <td>
