    ...
    <div class="">
        ...
        <div class="row justify-content-center">
                    ...
                    <div>
                        <table class="table table-bordered border-dark">
                            ...
                            <thead class="text-center">
                                ...
                                @php
                                    $first_ma = $ma_categories->first();
                                    $first_item = $first_ma->maItems->first();
                                ...
                                @endphp
                                <tr class="table-dark">
                                    <th class="p-0 m-0" style="font-size: 10px">ดำเนินการเมื่อ</th>
                                    <th class="p-0 m-0" style="font-size: 8px">
                                        {{ $column_data1->date ?? false ? (new Carbon\Carbon($column_data1->date))->thaidate('j/m/Y') : '' }}
                                    </th>
                                    <th class="p-0 m-0" style="font-size: 8px">
                                        {{ $column_data2->date ?? false ? (new Carbon\Carbon($column_data2->date))->thaidate('j/m/Y') : '' }}
                                    </th>
                                    <th class="p-0 m-0" style="font-size: 8px">
                                        {{ $column_data3->date ?? false ? (new Carbon\Carbon($column_data3->date))->thaidate('j/m/Y') : '' }}
                                    </th>
                                    <th class="p-0 m-0" style="font-size: 8px">
                                        {{ $column_data4->date ?? false ? (new Carbon\Carbon($column_data4->date))->thaidate('j/m/Y') : '' }}
                                    </th>
                                </tr>
                                <tr class="table-dark">
                                    ...
                                    <th class="p-0 m-0" style="font-size: 8px">
                                        <table width="100%">
                                            <tr>
                                                <td class="border-end border-dark" style="width:33%">ตรวจสอบ</td>
                                                <td class="border-end border-dark" style="width:34%">ปรับตั้ง</td>
                                                <td style="width:33%">เปลี่ยนใหม่</td>
                                            </tr>
                                        </table>
                                    </th>
                                    <th class="p-0 m-0" style="font-size: 8px">
                                ...
                                @foreach ($ma_categories ?? [] as $index => $ma_cate)
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td class="p-0">
                                            <table width="100%">
                                                <tr>
                                                    <td class="border-end border-dark" style="width:33%">{!! $column_data1->action_check ?? false ? '<i class="bi bi-check-lg"></i>' : '<span class="invisible">-</span>' !!}</td>
                                                    <td class="border-end border-dark" style="width:34%">{!! $column_data1->action_adjust ?? false ? '<i class="bi bi-check-lg"></i>' : '<span class="invisible">-</span>' !!}</td>
                                                    <td style="width:33%">{!! $column_data1->action_replace ?? false ? '<i class="bi bi-check-lg"></i>' : '<span class="invisible">-</span>' !!}</td>
                                                </tr>
                                            </table>
                                        </td>
                                        <td class="p-0">
                                            <table width="100%">
                                                <tr>
                                                    <td class="border-end border-dark" style="width:33%">{!! $column_data2->action_check ?? false ? '<i class="bi bi-check-lg"></i>' : '<span class="invisible">-</span>' !!}</td>
                                                    <td class="border-end border-dark" style="width:34%">{!! $column_data2->action_adjust ?? false ? '<i class="bi bi-check-lg"></i>' : '<span class="invisible">-</span>' !!}</td>
                                                    <td style="width:33%">{!! $column_data2->action_replace ?? false ? '<i class="bi bi-check-lg"></i>' : '<span class="invisible">-</span>' !!}</td>
                                                </tr>
                                            </table>
                                        </td>
                                        <td class="p-0">
                                            <table width="100%">
                                                <tr>
                                                    <td class="border-end border-dark" style="width:33%">{!! $column_data3->action_check ?? false ? '<i class="bi bi-check-lg"></i>' : '<span class="invisible">-</span>' !!}</td>
                                                    <td class="border-end border-dark" style="width:34%">{!! $column_data3->action_adjust ?? false ? '<i class="bi bi-check-lg"></i>' : '<span class="invisible">-</span>' !!}</td>
                                                    <td style="width:33%">{!! $column_data3->action_replace ?? false ? '<i class="bi bi-check-lg"></i>' : '<span class="invisible">-</span>' !!}</td>
                                                </tr>
                                            </table>
                                        </td>
                                        <td class="p-0">
                                            <table width="100%">
                                                <tr>
                                                    <td class="border-end border-dark" style="width:33%">{!! $column_data4->action_check ?? false ? '<i class="bi bi-check-lg"></i>' : '<span class="invisible">-</span>' !!}</td>
                                                    <td class="border-end border-dark" style="width:34%">{!! $column_data4->action_adjust ?? false ? '<i class="bi bi-check-lg"></i>' : '<span class="invisible">-</span>' !!}</td>
                                                    <td style="width:33%">{!! $column_data4->action_replace ?? false ? '<i class="bi bi-check-lg"></i>' : '<span class="invisible">-</span>' !!}</td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
            ...
            <div class="d-flex justify-content-center gap-2 mt-2">
                ...
                <a href="{{ route('logbook.show', ['logbook_id' => $logbook->id]) }}" class="btn btn-secondary">กลับ</a>
            </div>
        </div>
    </div>
    <script>
